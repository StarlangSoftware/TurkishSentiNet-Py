...
class SentiSynSetTest(unittest.TestCase):
    ...
    def test_saveAsXml(self):
        ...
        line = input.readline()
        self.assertEqual("<SYNSET><ID>TUR10-1093230</ID><PSCORE>0.25</PSCORE><NSCORE>0.0</NSCORE></SYNSET>\n", line)
        line = input.readline()
        self.assertEqual("<SYNSET><ID>TUR10-0730690</ID><PSCORE>0.0</PSCORE><NSCORE>0.0</NSCORE></SYNSET>\n", line)
        line = input.readline()
        self.assertEqual("<SYNSET><ID>TUR10-0969360</ID><PSCORE>0.0</PSCORE><NSCORE>1.0</NSCORE></SYNSET>\n", line)
        input.close()
